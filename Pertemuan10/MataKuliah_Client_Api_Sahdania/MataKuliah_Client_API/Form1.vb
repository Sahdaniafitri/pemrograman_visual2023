...
Public Class Form1
    Private Sub TambahData()
        ...
        Dim kodemk As String = txtKodeMK.Text
    ...
    Private Sub UpdateData()
        ...
        Try
            ...
            Dim responseBytes As Byte() = client.UploadData(matakuliah_api & "?kodemk=" & txtKodeMK.Text, "PUT", byteArray)
    ...
    Private Sub DeleteData()
        ...
        Try
            ...
            ' Send the PUT request and get the response
            Dim responseBytes As Byte() = client.UploadData(matakuliah_api & "?kodemk=" & txtKodeMK.Text, "DELETE", byteArray)
    ...
    Private Sub GetData()
        Using client As New HttpClient()
            ...
            Dim response As HttpResponseMessage = client.GetAsync(matakuliah_api & "?kodemk=" & txtKodeMK.Text).Result
